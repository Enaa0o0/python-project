...
MENU_PROMPT = """ -- COFFEE BEAN STATION --

Please choose one of these options

1. Add a new bean.
2. See all the beans available.
3. Search for a bean by its name.
4. See which preparation method is suitable for the bean.
5. Exit
...
def prompt_add_new_bean(connection):
    ...
    rating = int(input("Enter your rating score (from 0 to 10): "))
